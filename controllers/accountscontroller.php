...
class Passwords {
    ...
    public function __construct() {
        ...
        Passwords::$newPassword = HttpHelper::getParam("newPassword") == null
                                  ? "" : HttpHelper::getParam("newPassword");
        Passwords::$confirmPassword = HttpHelper::getParam("confirmPassword") == null
                                      ? "" : HttpHelper::getParam("confirmPassword");
        Passwords::$oldPassword = HttpHelper::getParam("oldPassword") == null
                                  ? "" : HttpHelper::getParam("oldPassword");

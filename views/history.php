...
<html lang="fr">
    <head>
        <meta charset="UTF-8">
        <link href="/yellow-checkyourmood-yellow2/codeCYM/third-party/bootstrap/css/bootstrap.css" rel="stylesheet"/>
        <link href="/yellow-checkyourmood-yellow2/codeCYM/CSS/history.css" rel="stylesheet"/>
        <link rel="stylesheet" href="/yellow-checkyourmood-yellow2/codeCYM/third-party/fontawesome-free-6.2.0-web/css/all.css">
        <link rel="apple-touch-icon" sizes="180x180" href="/yellow-checkyourmood-yellow2/codeCYM/assets/favicon/apple-touch-icon.png">
        <link rel="icon" type="image/png" sizes="32x32" href="/yellow-checkyourmood-yellow2/codeCYM/assets/favicon/favicon-32x32.png">
        <link rel="icon" type="image/png" sizes="16x16" href="/yellow-checkyourmood-yellow2/codeCYM/assets/favicon/favicon-16x16.png">
        <link rel="manifest" href="/site.webmanifest">
        <link rel="mask-icon" href="/yellow-checkyourmood-yellow2/codeCYM/assets/favicon/safari-pinned-tab.svg" color="#5bbad5">
        <meta name="msapplication-TileColor" content="#da532c">
        <meta name="theme-color" content="#ffffff">
        <meta name="viewport" content="width=device-width, initial-scale=1.0, shrink-to-fit=no" />
        <script src="/yellow-checkyourmood-yellow2/codeCYM/JS/history.js"></script>
        <script src="/yellow-checkyourmood-yellow2/codeCYM/third-party/JQuery/jquery-3.6.1.js"></script>
        <title>Historique</title>
        <script src="/yellow-checkyourmood-yellow2/codeCYM/JS/header-component.js" defer></script>
    </head>
    <body>
    <?php
